...
-- Nếu deploy code trước, upsert của challengeCloud.ts sẽ lỗi "relation does not exist"
-- (đồng bộ challenge tạm ngưng — local vẫn hiển thị được, nhưng đừng để trôi lâu).
--
...
-- Bật RLS + policy owner-only: mỗi người CHỈ đọc/ghi challenge của chính mình.
