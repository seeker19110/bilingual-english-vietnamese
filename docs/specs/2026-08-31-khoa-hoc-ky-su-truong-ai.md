...
Companion dẫn từng bài theo vòng lặp *concept → code → quiz → artifact*, đích đến là năng lực
...
export interface DiagnosticAnswer { questionId: string; correct: boolean }
