# PROGRESS.md — kho lưu trữ phần đã hoàn tất (cắt ngày 2026-09-06)

> **Đây KHÔNG phải trạng thái hiện tại.** File này giữ nguyên văn những phần của `PROGRESS.md`
> đã hoàn tất hoặc đã bị thay thế, cắt ra ngày 2026-09-06 (đánh giá sâu dự án, xem
> `docs/changelog/0276-*.md`) để `PROGRESS.md` chỉ còn đúng bốn thứ: giai đoạn hiện tại · việc
> tiếp theo · việc cần làm tay · quyết định + nợ kỹ thuật còn mở.
>
> Gồm bốn khối, theo thứ tự cũ trong `PROGRESS.md`:
>
> 1. "Lộ trình mới: English Tutor OS" (đã FROZEN, xem `ENGLISH_TUTOR_OS_V1_FROZEN.md`) + nhật ký
>    các đợt việc 2026-08-03 → 08-13 (trước khi tách `docs/changelog/`).
> 2. "GĐ2 (nền tảng đa môn)" — kho kiến thức 4 môn STEM, nay theo dõi ở
>    `docs/goals/2026-08-31-mon-hoc-toan-ly-hoa-sinh.md`.
> 3. Toàn bộ mục "Tiếp theo" cũ — hầu hết đã ✅; phần còn mở đã viết lại gọn trong `PROGRESS.md`.
> 4. Một mục nhật ký PR #648 từng nằm lạc trong "Nợ kỹ thuật còn mở".
>
> Tra cứu lịch sử đầy đủ: `npm run changelog -- --all` và `git log`.
