...
export const MILESTONE_TIERS: ReferralMilestoneDefinition[] = [
  ...
  },
  {
    ...
    rewardDescription: '+7 Ngày VIP + Mở khóa Huy hiệu Đại Sứ Học Tập (Ambassador)',
    bonusVipDays: 7,
  ...
  },
  {
    ...
    rewardDescription: '+7 Ngày VIP + Bộ Công cụ Phân tích Nhận thức Sâu V6',
    bonusVipDays: 7,
  ...
  },
  {
    ...
    rewardDescription: '+7 Ngày VIP + Danh hiệu Vinh quang Diamond Master',
    bonusVipDays: 7,
