    ...
    <div className="min-h-dvh bg-zinc-950 flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm glass rounded-2xl p-6 shadow-2xl shadow-black/40 animate-scale-in delay-100">
        ...
        <button
          ...
          disabled={loading}
          /* Xanh Facebook đậm hơn thương hiệu gốc #1877F2 một chút: chữ trắng 14px cần
             ≥ 4.5:1 (bản gốc chỉ 4.23:1) — xem cổng a11y AA.
             Cả 3 nút OAuth dùng `text-[#fff]` (trắng THẬT) chứ KHÔNG dùng `text-white`:
             `white` map sang token --c-white, ở theme nền sáng token này bị đảo thành màu
             TỐI → chữ tối trên nền thương hiệu tối, gần như không đọc được. */
          className="w-full flex items-center justify-center gap-2.5 bg-[#1772E8] hover:bg-[#1567D6] disabled:opacity-50 text-[#fff] font-medium py-3 rounded-xl text-sm transition active:scale-[0.98] mt-2.5"
        >
