            ...
            {misconceptions.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-xs text-red-300/90 font-mono bg-red-950/30 p-1.5 rounded border border-red-500/20 mb-2">
                    ❌ &ldquo;{m.surfaceErrorPattern}&rdquo;
                  </div>
                  <p className="text-xs text-slate-400 line-clamp-2">{m.rootCauseAnalysis}</p>
                </div>
              )
            })}
          </div>
            ...
            {activeSession.turns.map((turn, idx) => (
              <div key={idx} className="space-y-2">
                ...
                <div className="p-3 rounded-xl bg-violet-950/40 border border-violet-500/30 text-xs text-violet-100 flex items-start gap-2.5">
                  ...
                  <div>
                    <div className="font-semibold text-violet-300 mb-0.5">Câu hỏi dẫn dắt:</div>
                ...
                {turn.learnerAnswer && (
                  <div className="p-3 rounded-xl bg-slate-800/80 border border-slate-700 text-xs text-slate-200 ml-6 flex items-start gap-2">
                    <span className="font-bold text-emerald-400">Bạn: </span>
