...
- **[2026-08-26] ✅ HAI TÍNH NĂNG GIỮ CHÂN ĐÃ LÀM XONG (đặc tả + code + test + cổng a11y).**
  Đợt research-first 2026-08-26 (`docs/changelog/0165-*.md`) rồi thi hành trọn vẹn cùng ngày
  (`0166-*.md` và `0167-*.md`):
  1. **Chế độ ôn thi có hạn chót** — ✅ **XONG E1–E4 (2026-08-26)**, xem
     `docs/changelog/0167-*.md`. Gói mới `packages/core-examplan` (lập lịch ngược, hàm thuần),
  ...
  2. **Người thân theo dõi (báo cáo tuần cho phụ huynh)** — ✅ **XONG C1–C4 (2026-08-26)**,
     xem `docs/changelog/0166-*.md`. Migration `0069_companion_links.sql`, service
