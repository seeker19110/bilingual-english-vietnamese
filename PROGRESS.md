...
- **[2026-08-27] Môn Lập trình — 13 HƯỚNG CHUYÊN SÂU + BẢN ĐỒ KIẾN TRÚC (bản đồ sau P5) — ✅ XONG.** Đặc tả:
  ...
  **Tiến độ hướng đã LƯU XUỐNG POSTGRES (2026-08-27, nhật ký `docs/changelog/0176-*.md`)** —
  ...
  **Việc để ngỏ (cố ý):** chưa soạn bài 8 bước cho hướng nào (nên bắt đầu từ `web`); chưa nối
  tiến độ chặng với tiến độ bài học (đánh dấu chặng vẫn là thao tác tay); chưa gợi ý hướng theo
  hồ sơ người học.
