...
- **Migration docs** (2026-07-05) — ĐÃ LÀM phần tài liệu: thêm cảnh báo + bước kiểm tra migration
  vào `docs/deploy-vps-ubuntu.md` mục "Cập nhật code mới (deploy lại)" (trước đây KHÔNG có bước
