...
- **Tương phản (a11y):** chữ nội dung trong các trang đã sửa nâng từ `zinc-400` lên `zinc-300`;
  mọi chữ màu nhấn đều có cặp `theme-light:text-accent-800/900` (a-\* KHÔNG đảo theo theme
  nên thiếu cặp này là hỏng tương phản ở 3 theme nền sáng). Xoá các class chết `accent-950`
  (thang accent của hub chỉ tới 900 — class cũ không sinh CSS).
