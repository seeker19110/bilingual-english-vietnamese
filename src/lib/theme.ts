...
export const THEMES: {
  ...
  { value: 'dark-blue', labelVi: 'Xanh đêm', labelEn: 'Night blue', emoji: '🌙', swatchBg: '#0f172a', swatchAccent: '#10b981' },
  { value: 'blue-sky', labelVi: 'Blue sky', labelEn: 'Blue sky', emoji: '☀️', swatchBg: '#f0f9ff', swatchAccent: '#0ea5e9' },
  { value: 'pink', labelVi: 'Pink', labelEn: 'Pink', emoji: '🌸', swatchBg: '#fff8fc', swatchAccent: '#ec4899' },
  { value: 'vibrant', labelVi: 'Rực rỡ', labelEn: 'Vibrant', emoji: '🎉', swatchBg: '#1c1428', swatchAccent: '#d946ef' },
]
