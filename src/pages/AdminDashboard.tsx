      ...
      <main className="max-w-4xl mx-auto px-4 pt-6 pb-[calc(1.5rem+var(--bnav-h))]">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          {/* Tab ngang cuộn được trên mobile, menu dọc bên trái trên desktop. 6 tab hiện đã
              rộng hơn 1 màn hình mobile — dải mờ bên phải (chỉ hiện trên mobile) gợi ý còn tab
              cuộn tiếp, tránh người dùng tưởng chỉ có 1 tab "Sử dụng & chi phí". */}
          <div className="relative md:contents">
            ...
            <div
              aria-hidden="true"
              className="pointer-events-none absolute right-0 top-0 bottom-1 w-10 bg-gradient-to-l from-zinc-950 to-transparent md:hidden"
            />
          </div>
