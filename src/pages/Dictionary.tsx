...
const QUICK_TOPICS = [
  { labelVi: 'Chào hỏi',   labelEn: 'Greetings',  words: ['hello', 'thank', 'sorry', 'please', 'goodbye'] },
  { labelVi: 'Gia đình',   labelEn: 'Family',      words: ['mother', 'father', 'brother', 'sister', 'child'] },
  { labelVi: 'Thức ăn',    labelEn: 'Food & Drink',words: ['rice', 'bread', 'coffee', 'water', 'fruit'] },
  { labelVi: 'Công việc',  labelEn: 'Work',         words: ['work', 'office', 'meeting', 'project', 'salary'] },
  { labelVi: 'Trường học', labelEn: 'School',       words: ['student', 'teacher', 'exam', 'class', 'study'] },
  { labelVi: 'Cảm xúc',   labelEn: 'Feelings',     words: ['happy', 'sad', 'angry', 'love', 'afraid'] },
  { labelVi: 'Sức khỏe',  labelEn: 'Health',        words: ['doctor', 'hospital', 'pain', 'medicine', 'sleep'] },
  { labelVi: 'Di chuyển', labelEn: 'Getting around',words: ['road', 'bus', 'walk', 'far', 'direction'] },
]
...
export default function Dictionary() {
  ...
  useEffect(() => { setPage(0) }, [deferredQuery, posFilter])
        ...
        {tab === 'search' ? (
          ...
          <div className="space-y-3 animate-fade-in">
            <div className="glass rounded-xl p-4">
              <p className="text-sm text-zinc-300 leading-relaxed">
                <strong className="text-white">{isA ? 'Loại từ (Parts of speech)' : 'Parts of speech'}</strong>
                {isA
