...
export const FOUNDATION: Circle[] = [
  ...
  // ── Vòng 15: Kinh doanh & công sở ────────────────────────────────────────
  {
    ...
    emoji: '💼',
    words: [
      w('meeting',      'n', 'cuộc họp',        'The meeting is at 9 AM.',           'Cuộc họp lúc 9 giờ sáng.'),
      w('deadline',     'n', 'hạn chót',        'The deadline is Friday.',           'Hạn chót là thứ Sáu.'),
      w('budget',       'n', 'ngân sách',       'We are over budget.',               'Chúng ta vượt ngân sách.'),
      w('contract',     'n', 'hợp đồng',        'Please sign the contract.',         'Hãy ký hợp đồng.'),
      w('salary',       'n', 'lương',           'My salary increased this year.',    'Lương tôi tăng năm nay.'),
      w('profit',       'n', 'lợi nhuận',       'Our profit is growing.',            'Lợi nhuận của chúng ta đang tăng.'),
      w('market',       'n', 'thị trường',      'The market is competitive.',        'Thị trường rất cạnh tranh.'),
      w('client',       'n', 'khách hàng',      'The client is satisfied.',          'Khách hàng hài lòng.'),
      w('project',      'n', 'dự án',           'Our project is on track.',          'Dự án của chúng ta đúng tiến độ.'),
      w('manager',      'n', 'quản lý',         'The manager approved the plan.',    'Quản lý đã phê duyệt kế hoạch.'),
      w('invoice',      'n', 'hóa đơn',         'Please send the invoice.',          'Hãy gửi hóa đơn.'),
      w('report',       'n', 'báo cáo',         'Submit the report by Monday.',      'Nộp báo cáo trước thứ Hai.'),
      w('strategy',     'n', 'chiến lược',      'We need a new strategy.',           'Chúng ta cần chiến lược mới.'),
      w('negotiation',  'n', 'đàm phán',        'The negotiation was successful.',   'Đàm phán thành công.'),
      w('presentation', 'n', 'thuyết trình',   'I have a presentation today.',      'Hôm nay tôi có thuyết trình.'),
      w('expense',      'n', 'chi phí',         'Track your expenses.',              'Theo dõi chi phí của bạn.'),
      w('revenue',      'n', 'doanh thu',       'Revenue increased by 20%.',         'Doanh thu tăng 20%.'),
      w('partnership',  'n', 'đối tác',         'We formed a partnership.',          'Chúng tôi đã hình thành quan hệ đối tác.'),
      w('startup',      'n', 'công ty khởi nghiệp', 'She runs a startup.',           'Cô ấy điều hành một startup.'),
      w('office',       'n', 'văn phòng',       'The office is open at 8 AM.',       'Văn phòng mở cửa lúc 8 giờ sáng.'),
    ],
    sentences: [
      { en: 'The deadline is Friday.',      vi: 'Hạn chót là thứ Sáu.' },
