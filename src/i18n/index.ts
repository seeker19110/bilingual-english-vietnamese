...
export const t = {
  vi: {
    ...
    loginSub: 'Đăng nhập để tiếp tục luyện tập',
    emailPlaceholder: 'Email của bạn',
    passwordPlaceholder: 'Mật khẩu',
    loginBtn: 'Đăng nhập',
    loginLoading: 'Đang đăng nhập…',
    demoHint: 'Demo: dùng bất kỳ email + mật khẩu ≥ 6 ký tự',
  ...
  en: {
    ...
    loginSub: 'Log in to continue practising',
    emailPlaceholder: 'Your email',
    passwordPlaceholder: 'Password',
    loginBtn: 'Log in',
    loginLoading: 'Logging in…',
    demoHint: 'Demo: use any email + password ≥ 6 characters',
