// src/components/admin/AdminLimitsPanel.tsx — Nội dung tab "Hạn mức & khuyến mãi" trong /admin.
// Trang riêng /admin-settings (src/pages/AdminSettings.tsx) đã bị xoá — route cũ giờ redirect
// sang /admin?tab=limits (xem src/App.tsx), tab này là nơi duy nhất chứa logic/API
// /api/admin-settings.
//
