...
// Tạo ô màu sắc động
const colorSwatch = (fill: string, stroke = fill): IllFn => () => (
  <>
    <rect x="10" y="10" width="80" height="80" rx="16" fill={fill} stroke={stroke} strokeWidth="3" />
    <rect x="20" y="20" width="24" height="14" rx="7" fill="white" opacity="0.25" />
  </>
)

// Hiển thị số
const numSvg = (n: number | string): IllFn => () => (
  <>
    <rect x="10" y="10" width="80" height="80" rx="16" fill="#1e293b" />
    <text x="50" y="68" textAnchor="middle" fontSize={String(n).length > 2 ? 28 : 50}
      fontWeight="bold" fill="#34d399" fontFamily="monospace">{n}</text>
  </>
)
...
const ILL: Record<string, IllFn> = {
  ...
  // ── Số ───────────────────────────────────────────────────────
  zero:     numSvg(0),  one:  numSvg(1),  two:   numSvg(2),
  three:    numSvg(3),  four: numSvg(4),  five:  numSvg(5),
  six:      numSvg(6),  seven:numSvg(7),  eight: numSvg(8),
  nine:     numSvg(9),  ten:  numSvg(10), eleven:numSvg(11),
  twelve:   numSvg(12), twenty:numSvg(20),hundred:numSvg(100),
  thousand: numSvg('1k'),
  ...
  square: () => (
    <rect x="12" y="12" width="76" height="76" rx="4" fill="none" stroke="#60a5fa" strokeWidth="6" />
  ),
  triangle: () => (
    <polygon points="50,8 93,90 7,90" fill="none" stroke="#f59e0b" strokeWidth="5" />
  ),
  rectangle: () => (
  ...
  heart: () => (
    <path d="M50 82 C50 82 10 56 10 30 C10 15 22 8 32 8 C39 8 45 12 50 19
    ...
    return (
      <>
        ...
        {rays.map((deg, i) => {
          ...
          return (
            <line key={i}
              x1={50 + 27 * Math.cos(r)} y1={50 + 27 * Math.sin(r)}
  ...
  moon: () => (
    <path d="M65 20 A30 30 0 1 0 65 80 A20 20 0 1 1 65 20Z" fill="#e2e8f0" />
  ),
  cloud: () => (
    <>
  ...
  rain: () => (
    <>
      ...
      {([[34,58],[44,65],[54,58],[64,65],[39,73],[59,73]] as [number,number][]).map(([x,y], i) => (
        <line key={i} x1={x} y1={y - 5} x2={x - 3} y2={y + 8}
  ...
  wind: () => (
    <>
      {[30, 45, 60].map((y, i) => (
        <path key={i} d={`M8 ${y} Q${50 - i * 5} ${y - 12} 88 ${y}`}
          stroke="#94a3b8" strokeWidth="3.5" fill="none" strokeLinecap="round" />
      ))}
    </>
  ),
  snow: () => (
    <>
      {([[25,30],[55,20],[75,40],[20,65],[55,60],[80,72]] as [number,number][]).map(([x,y], i) => (
        <text key={i} x={x} y={y} fontSize={12 + i % 3 * 4} fill="white" opacity="0.85">❄</text>
      ))}
    </>
  ),
  thunder: () => (
    ...
    return (
      <>
        ...
        {petals.map((deg, i) => {
          ...
          return (
            <ellipse key={i} cx={cx} cy={cy} rx="10" ry="7"
              fill="#f9a8d4" transform={`rotate(${deg} ${cx} ${cy})`} />
          )
        })}
  ...
  river: () => (
    <path d="M15 10 Q35 35 20 60 Q8 80 30 90"
  ...
  cat: () => (
    <>
      ...
      {([[50,44,28,42],[50,45,28,47],[50,44,72,42],[50,45,72,47]] as number[][]).map(([x1,y1,x2,y2],i) => (
        <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#e2e8f0" strokeWidth="1.5" />
      ))}
      <path d="M74 70 Q90 54 86 40" stroke="#94a3b8" strokeWidth="5" fill="none" strokeLinecap="round" />
    </>
  ),
  dog: () => (
    <>
      ...
      <path d="M78 58 Q96 44 92 30" stroke="#a78bfa" strokeWidth="5" fill="none" strokeLinecap="round" />
    </>
  ),
  bird: () => (
    <>
  ...
  elephant: () => (
    <>
      ...
      <path d="M18 48 Q6 62 13 76 Q17 83 22 75"
        stroke="#9ca3af" strokeWidth="10" fill="none" strokeLinecap="round" />
      <circle cx="24" cy="35" r="3" fill="#1e293b" />
      <circle cx="25" cy="34" r="1" fill="white" />
      <path d="M16 52 Q4 58 7 67" stroke="#fef3c7" strokeWidth="3" fill="none" strokeLinecap="round" />
      {[32, 46, 60, 74].map((x, i) => (
  ...
  horse: () => (
    <>
      ...
      <path d="M30 50 Q28 30 38 22" stroke="#92400e" strokeWidth="16" fill="none" strokeLinecap="round" />
      <ellipse cx="42" cy="18" rx="16" ry="12" fill="#92400e" transform="rotate(-20 42 18)" />
      <path d="M30 48 Q24 34 34 22" stroke="#7c2d12" strokeWidth="6" fill="none" strokeLinecap="round" />
      <circle cx="35" cy="14" r="3" fill="#1e293b" />
      {[28, 40, 58, 70].map((x, i) => (
        <rect key={i} x={x} y="76" width="8" height="18" rx="3" fill="#78350f" />
      ))}
      <path d="M82 62 Q96 56 90 80" stroke="#7c2d12" strokeWidth="5" fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  apple: () => (
    <>
      ...
      <path d="M50 24 Q56 10 63 14" stroke="#22c55e" strokeWidth="3" fill="none" strokeLinecap="round" />
      <ellipse cx="38" cy="46" rx="8" ry="12" fill="white" opacity="0.2" />
    </>
  ),
  banana: () => (
    <path d="M20 76 Q25 30 56 18 Q80 12 82 30 Q84 46 60 62 Q40 76 20 76Z"
      fill="#fbbf24" stroke="#d97706" strokeWidth="2" />
  ),
  egg: () => (
  ...
  milk: () => (
    <>
      ...
      <text x="50" y="60" textAnchor="middle" fontSize="9" fill="#9ca3af" fontWeight="bold">MILK</text>
    </>
  ),
  water: () => (
    <path d="M50 8 Q72 36 72 56 A22 22 0 0 1 28 56 Q28 36 50 8Z"
  ...
  coffee: () => (
    <>
      ...
      {[[35,38],[45,35]].map(([x,y], i) => (
        <path key={i} d={`M${x} ${y} Q${x-2} ${y-10} ${x+3} ${y-18}`}
  ...
  rice: () => (
    <>
      ...
      {([[36,50],[44,44],[54,47],[62,53],[40,58],[55,56]] as [number,number][]).map(([x,y], i) => (
        <ellipse key={i} cx={x} cy={y} rx="5" ry="2.5"
          fill="#fef9c3" transform={`rotate(${i * 30} ${x} ${y})`} />
      ))}
    </>
  ),
  ...
  phone: () => (
    <>
      <rect x="28" y="8" width="44" height="84" rx="12" fill="#1e293b" stroke="#374151" strokeWidth="3" />
  ...
  computer: () => (
    <>
      <rect x="12" y="12" width="76" height="52" rx="6" fill="#1e293b" stroke="#374151" strokeWidth="3" />
        ...
        {ticks.map((deg, i) => {
          ...
          return (
            <line key={i}
              ...
              stroke="#4b5563" strokeWidth={i % 3 === 0 ? 3 : 1.5} />
          )
        })}
        <line x1="50" y1="50" x2="30" y2="28" stroke="#e2e8f0" strokeWidth="4" strokeLinecap="round" />
        <line x1="50" y1="50" x2="72" y2="30" stroke="#34d399" strokeWidth="3" strokeLinecap="round" />
  ...
  eye: () => (
    <>
      <path d="M5 50 Q30 15 50 15 Q70 15 95 50 Q70 85 50 85 Q30 85 5 50Z"
  ...
  nose: () => (
    <path d="M50 14 Q38 40 32 60 Q30 73 38 77 Q44 81 50 75 Q56 81 62 77
             Q70 73 68 60 Q62 40 50 14Z"
      fill="#fca5a5" stroke="#f87171" strokeWidth="2" />
  ),
  mouth: () => (
    <>
      <path d="M20 46 Q50 72 80 46" fill="#fecaca" />
      <path d="M20 46 Q50 72 80 46" stroke="#f87171" strokeWidth="4" fill="none" strokeLinecap="round" />
  ...
  hand: () => (
    <>
      ...
      <rect x="20" y="34" width="10" height="24" rx="5" fill="#fca5a5"
  ...
  head: () => (
    <>
      <path d="M18 38 Q16 10 50 8 Q84 10 82 38 Q70 15 50 14 Q30 15 18 38Z"
        fill="#92400e" />
      ...
      <path d="M40 57 Q50 65 60 57" stroke="#f87171" strokeWidth="2.5" fill="none" strokeLinecap="round" />
    </>
  ),
  ...
  fire: () => (
    <>
      <path d="M50 10 Q65 30 60 46 Q76 30 70 52 Q82 40 78 58
               Q82 80 50 92 Q18 80 22 58 Q18 40 30 52
               Q24 30 40 46 Q35 30 50 10Z" fill="#f97316" />
      <path d="M50 32 Q58 46 55 56 Q63 46 62 58 Q65 72 50 82
               Q35 72 38 58 Q37 46 45 56 Q42 46 50 32Z" fill="#fbbf24" />
    </>
  ),
  music: () => (
    <>
      <path d="M38 72 L38 30 L76 18 L76 55"
        stroke="#a855f7" strokeWidth="4" fill="none" />
      <circle cx="32" cy="74" r="10" fill="#a855f7" />
      <circle cx="70" cy="57" r="10" fill="#a855f7" />
      <text x="72" y="24" fontSize="13" fill="#c084fc">♪</text>
    </>
  ),
  school: () => (
    <>
  ...
  money: () => (
    <>
      <circle cx="50" cy="50" r="38" fill="#22c55e" opacity="0.2" stroke="#22c55e" strokeWidth="3" />
      <text x="50" y="62" textAnchor="middle" fontSize="44" fontWeight="bold" fill="#22c55e">$</text>
    </>
  ),
  key: () => (
    <>
      <circle cx="32" cy="40" r="20" fill="none" stroke="#fbbf24" strokeWidth="5" />
      <line x1="52" y1="40" x2="90" y2="40" stroke="#fbbf24" strokeWidth="5" strokeLinecap="round" />
      <line x1="80" y1="40" x2="80" y2="55" stroke="#fbbf24" strokeWidth="5" strokeLinecap="round" />
      <line x1="68" y1="40" x2="68" y2="52" stroke="#fbbf24" strokeWidth="5" strokeLinecap="round" />
    </>
  ),
  door: () => (
    <>
      <rect x="22" y="10" width="56" height="82" rx="4" fill="#92400e" stroke="#78350f" strokeWidth="3" />
  ...
  window: () => (
    <>
      <rect x="12" y="12" width="76" height="76" rx="6" fill="#bae6fd" stroke="#60a5fa" strokeWidth="4" />
  ...
  ball: () => (
    <>
      ...
      <path d="M50 12 Q65 28 65 50 Q65 72 50 88" stroke="white" strokeWidth="3" fill="none" opacity="0.6" />
      <path d="M14 38 Q30 44 50 44 Q70 44 86 38" stroke="white" strokeWidth="3" fill="none" opacity="0.6" />
      <path d="M14 62 Q30 56 50 56 Q70 56 86 62" stroke="white" strokeWidth="3" fill="none" opacity="0.6" />
    </>
  ),
  umbrella: () => (
    <>
      <path d="M10 50 Q10 10 50 8 Q90 10 90 50Z" fill="#60a5fa" />
      <line x1="50" y1="50" x2="50" y2="85" stroke="#1e40af" strokeWidth="4" strokeLinecap="round" />
      <path d="M50 82 Q44 92 38 88" stroke="#1e40af" strokeWidth="4" fill="none" strokeLinecap="round" />
      {[20, 50, 80].map((x, i) => (
        <line key={i} x1={x} y1="50" x2={50 + (x - 50) * 0.3} y2="12"
          stroke="#93c5fd" strokeWidth="1.5" opacity="0.5" />
      ))}
    </>
  ),
}
